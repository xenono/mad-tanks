class CollisionDetection:
    ...
    def collision(dynamic_object, static_object):
        ...
        if dynamic_object.position['x'] + dynamic_object.width > static_object.position['x'] and dynamic_object.position['x'] < static_object.position[
            'x'] + static_object.width:
            if (static_object.position['y'] < dynamic_object.position['y'] < static_object.position['y'] + static_object.height) or (
                    static_object.position['y'] < dynamic_object.position['y'] + dynamic_object.height < static_object.position['y'] + static_object.height):
                return True
        return False
